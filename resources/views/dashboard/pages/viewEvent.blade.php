...
@section('content')
    ...
    <main class="content">
        <div class="container-fluid p-0">
            ...
            <div class="mb-3">
                <h1 class="h3 d-inline align-middle">New Event</h1>
            </div>
                ...
                <div class="col-xl-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form data-action="{{ route('update.dashboard.event') }}" id="event-form" data-ajaxify="true"
                                data-method="POST" class="js-validation" novalidate>
                                <input type="hidden" name="image" value="{{ $event->image }}" id="image" />
                                ...
                                <div class="mb-4">
                                    ...
                                    <select id="category" required name="category"
                                        ...
                                        @if($roleId == 1006)
                                        <option value="Commerce Club">Commerce Club</option>
                                        @elseif($roleId == 1007)
                                        <option value="Alumini">Alumini</option>
                                        @elseif($roleId == 1008)
                                        <option value="Indian Accouting Association">Indian Accouting Association</option>
                                        @elseif($roleId == 1009)
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" value="{{ $event->label }}" name="label" required
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" value="{{ $event->location }}" name="location" required
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Date</label>
                                    <input type="date" value="{{ $event->from_date }}" name="from_date" required
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Time</label>
                                    <input type="time" value="{{ $event->time }}" name="time"
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="short_description" required class="form-control form-control-lg form-control-solid " rows="6"
                                        placeholder="Textarea">{{ $event->short_description }}</textarea>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Content</label>
                                    <textarea name="content" class="form-control form-control-lg form-control-solid editor" rows="18"
                                        placeholder="Textarea">{{ $event->content }}</textarea>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Web Link to Join</label>
                                    <input type="text" value="{{ $event->joining_url }}" name="joining_url"
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Tags</label>
                                    <input type="text" value="{{ join(',', $event->tags) }}" name="tags"
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="seo_tags" class="form-control form-control-lg form-control-solid " rows="12"
                                        placeholder="Textarea" rows="8">{{ $event->seo_tags }}</textarea>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Sort Order</label>
                                    <input type="number" value="{{ $event->sort_order }}" required name="sort_order"
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="avatar-upload">
                                ...
                                <div class="avatar-preview">
                                    <div id="imagePreview" style="background-image: url({{ $event->image }});">
                                    </div>
                                </div>
                            </div>
