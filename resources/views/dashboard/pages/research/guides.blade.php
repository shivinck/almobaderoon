...
@section('content')
        ...
        <div class="container-fluid p-0">
            ...
            <div class="row mb-2 mb-xl-3">
                <div class="col-auto d-none d-sm-block">
                    <h3><strong>Research Guides</strong></h3>
                </div>

                <div class="col-auto ms-auto text-end mt-n1">
                    <a href="{{ route('get.dashboard.research.newGuide') }}" class="btn btn-primary">Add New</a>
                </div>
            </div>
    ...
    <form data-action="{{ route('post.dashboard.publishPost') }}" id="publish-post-form" data-ajaxify="true"
        ...
        <input type="hidden" name="type" value="researchGuide" />
        <input type="hidden" name="redirect" value="{{ route('get.dashboard.research.guides') }}" />
    </form>
