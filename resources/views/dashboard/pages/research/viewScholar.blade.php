...
@section('content')
    ...
    <main class="content">
        <div class="container-fluid p-0">
            ...
            <div class="mb-3">
                <h1 class="h3 d-inline align-middle">View Research Scholar</h1>
            </div>
                ...
                <div class="col-xl-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form data-action="{{ route('update.dashboard.research.scholar') }}" id="faculty-form" data-ajaxify="true"
                                data-method="POST" class="js-validation" novalidate>
                                <input type="hidden" value="{{ $scholar->id }}" name="id" id="id" />
                                <input type="hidden" value="{{ $scholar->image }}" name="image" id="image" />
                                <div class="mb-4">
                                    <label class="form-label"> Name</label>
                                    <input type="text" value="{{ $scholar->name }}" name="name" required
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Choose From Faculty</label>
                                    <select id="faculty_id" required name="faculty_id" class="form-control form-control-lg form-control-solid">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number" value="{{ $scholar->year }}" required name="year"
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Area of Research</label>
                                    <input type="text" value="{{ $scholar->area }}" required name="area"
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Research Topic</label>
                                    <input type="text" value="{{ $scholar->topic }}" required name="topic"
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="description" class="form-control form-control-lg form-control-solid editor" rows="12"
                                        placeholder="Textarea" rows="1">{{ $scholar->description }}</textarea>
                                </div>

                                <div class="mb-4">
                                    <label class="form-label">Sort Order</label>
                                    <input type="number" value="{{ $scholar->sort_order }}" name="sort_order" required
                                        class="form-control form-control-lg form-control-solid">
                                </div>


                                <button type="submit" id="save-btn" class="btn form-btn dnone btn-lg btn-primary">Save
                                    Information</button>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="avatar-upload">
                                ...
                                <div class="avatar-preview">
                                    <div id="imagePreview"
                                        style="background-image: url({{ $scholar->image }});">
                                    </div>
                                </div>
                            </div>
    ...
    @push('scripts')
        <script>
            ...
            document.getElementById('faculty_id').value='{{ $scholar->faculty_id }}';
        </script>
    @endpush
@endsection
