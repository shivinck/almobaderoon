...
@section('content')
    ...
    <main class="content">
        <div class="container-fluid p-0">
            ...
            <div class="mb-3">
                <h1 class="h3 d-inline align-middle">New Course</h1>
            </div>
                ...
                <div class="col-xl-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form data-action="{{ route('update.dashboard.course') }}" id="faculty-form" data-ajaxify="true"
                                data-method="POST" class="js-validation" novalidate>
                                <input type="hidden" value="{{ $course->image }}" name="image" id="image" />
                                <input type="hidden" value="{{ $course->id }}" name="id" id="id" />
                                <input type="hidden" value="{{ $course->document }}" name="document" id="document" />
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="type"  value="{{ $course->type }}" required
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    <label class="form-label">No of Seats Available</label>
                                    <input type="number" value="{{ $course->seats }}" name="seats" required
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Languages</label>
                                    <input type="text"  value="{{ $course->languages }}" name="languages" required
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="description" class="form-control form-control-lg form-control-solid editor" rows="12"
                                        placeholder="Textarea" rows="1">{{ $course->description }}</textarea>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Additional Notes</label>
                                    <textarea name="notes" class="form-control form-control-lg form-control-solid " rows="4"
                                        placeholder="Textarea" >{{ $course->notes }}</textarea>
                                </div>


                                <div class="mb-4">
                                    <div class="mb-4 dnone @if( $course->document_name) d-none @endif" id="file-input-wrapper">
                                    ...
                                    <div class="file-preview-thumbnails @if(!$course->document_name) d-none @endif" id="file-preview">
                                        <div class="file-preview-frame file-sortable  kv-preview-thumb"
                                            ...
                                            <div class="file-thumbnail-footer">
                                                <div class="file-detail">
                                                    <div class="file-caption-name" id="fileName">{{ $course->document_name }}</div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number" value="{{ $course->sort_order }}" required name="sort_order"
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">SEO Tags</label>
                                    <textarea name="seo_tags" class="form-control form-control-lg form-control-solid " rows="4"
                                        placeholder="Textarea" >{{ $course->seo_tags }}</textarea>
                                </div>


                                <button type="submit" id="save-btn" class="btn dnone form-btn  btn-lg btn-primary">Save
                                    Information</button>
                            </form>
                        </div>
                    </div>
    ...
    @push('scripts')
        <script>
            ...
            document.getElementById('remove-file').addEventListener('click', function(event) {
                ...
                document.getElementById('fileDataInputName').value = null;
