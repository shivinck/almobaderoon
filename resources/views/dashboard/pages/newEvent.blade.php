                ...
                <div class="col-xl-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form data-action="{{ route('post.dashboard.event') }}" id="event-form" data-ajaxify="true"
                                ...
                                <div class="mb-4">
                                    ...
                                    <select id="inputState" required name="category" id="category" class="form-control form-control-lg form-control-solid">
                                        @if($roleId == 1006)
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="joining_url"
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                <div class="mb-4">
