...
@section('content')
    ...
    <main class="content">
        <div class="container-fluid p-0">
            ...
            <div class="mb-3">
                <h1 class="h3 d-inline align-middle">{{ $event->title }}</h1>
            </div>
                                ...
                                <tbody>
                                    @foreach ($medias as $item)
                                        <tr>
                                            ...
                                            <td><img src="{{ $item->media }}" width="32" height="32" class="rounded-circle my-n1" alt="Avatar"></td>
                                            <td><strong>{{ $item->author->name }}</strong></td>
                ...
                <div class="col-xl-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form data-action="{{ route('post.dashboard.media') }}" id="event-form" data-ajaxify="true"
                            data-method="POST" class="js-validation" novalidate>
                            <input type="hidden" required name="event_id" id="event_id" value="{{ $event->id }}" />
                            <input type="hidden" required name="media" id="image" />
                            <button type="submit" id="save-btn" class="btn form-btn mt-4  btn-lg btn-primary">
                                Save Media</button>
                        </form>
    ...
    <form data-action="{{ route('post.dashboard.publishPost') }}" id="publish-post-form" data-ajaxify="true"
        ...
        <input type="hidden" name="type" value="eventGallery" />
        <input type="hidden" name="redirect" value="{{ route('get.dashboard.galleryMedias', $event->id) }}" />
    </form>
