...
@section('content')
        ...
        <div class="container-fluid p-0">
            ...
            <div class="row mb-2 mb-xl-3">
                <div class="col-auto d-none d-sm-block">
                    <h3><strong>Academic Calendar</strong></h3>
                </div>
                @if($isWritePermission)
                <div class="col-auto ms-auto text-end mt-n1">
                    <a href="{{ route('get.dashboard.newCalendar') }}" class="btn btn-primary">Add New</a>
                </div>
                @endif
            </div>
                        ...
                        <tbody>
                            @foreach ($events as $item)
                                <tr>
                                    ...
                                    <td><strong>{{ $item->from_date }}</strong></td>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ route('get.dashboard.viewCalendar', $item->id ) }}">View</a>
                                                @if($isWritePermission)
                                                <a class="dropdown-item" href="{{ route('get.dashboard.viewCalendar', ['id' => $item->id, 'isEdit' => 'true']) }}">Edit</a>
    ...
    <form data-action="{{ route('post.dashboard.publishPost') }}" id="publish-post-form" data-ajaxify="true"
        ...
        <input type="hidden" name="redirect" value="{{ route('get.dashboard.calendar') }}" />
    </form>
