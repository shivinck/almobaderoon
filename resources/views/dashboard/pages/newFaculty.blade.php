...
@section('content')
    ...
    <main class="content">
        <div class="container-fluid p-0">
            ...
            <div class="mb-3">
                <h1 class="h3 d-inline align-middle">New Faculty</h1>
            </div>
                ...
                <div class="col-xl-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form data-action="{{ route('post.dashboard.faculty') }}" id="faculty-form" data-ajaxify="true"
                                data-method="POST" class="js-validation" novalidate>
                                <input type="hidden" name="image" id="image" />
                                <input type="hidden" name="cv" id="document" />
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    <div class="mb-4" id="file-input-wrapper">
                                        <label class="form-label">Upload CV</label>
                                        <input type="file" name="education" accept="application/pdf"
                                            class="form-control form-control-lg form-control-solid" id="fileInput"
                                            accept="pdf" />
                                    </div>
                                    <div class="file-preview-thumbnails d-none" id="file-preview">
                                        <div class="file-preview-frame file-sortable  kv-preview-thumb"
                                            ...
                                            <div class="kv-file-content">
                                                <img src="https://cdn-icons-png.flaticon.com/128/337/337946.png"
                                                    class="file-preview-image kv-preview-data" title="360_new.jpg"
                                                    alt=""
                                                    style="width: auto; height: auto; max-width: 100%; max-height: 100%; image-orientation: from-image;">
                                            </div>
                                            <div class="file-thumbnail-footer">
                                                <div class="file-detail">
                                                    <div class="file-caption-name" id="fileName">360_new.jpg</div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="avatar-upload">
                                ...
                                <div class="avatar-preview">
                                    <div id="imagePreview"
                                        style="background-image: url(https://placehold.jp/200x300.png);">
                                    </div>
                                </div>
                            </div>
