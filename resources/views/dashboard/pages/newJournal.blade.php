...
@section('content')
    ...
    <main class="content">
        <div class="container-fluid p-0">
            ...
            <div class="mb-3">
                <h1 class="h3 d-inline align-middle">New Journal</h1>
            </div>
                ...
                <div class="col-xl-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form data-action="{{ route('post.dashboard.journal') }}" id="faculty-form" data-ajaxify="true"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="date" name="published_on" required
                                        class="form-control form-control-lg form-control-solid">
                                </div>
