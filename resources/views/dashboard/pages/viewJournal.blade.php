...
@section('content')
    ...
    <main class="content">
        <div class="container-fluid p-0">
            ...
            <div class="mb-3">
                <h1 class="h3 d-inline align-middle">View Journal</h1>
            </div>
                ...
                <div class="col-xl-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form data-action="{{ route('update.dashboard.journal') }}" id="faculty-form" data-ajaxify="true"
                                data-method="POST" class="js-validation" novalidate>
                                <input type="hidden" value="{{ $journal->image }}" name="image" id="image" />
                                <input type="hidden" value="{{ $journal->id }}" name="id" id="id" />
                                <input type="hidden" value="{{ $journal->document }}" name="document" id="document" />
                                {{-- <div class="mb-4">
                                    <label class="form-label">Label</label>
                                    <input type="text" value="{{ $journal->label }}"  name="label" required
                                        class="form-control form-control-lg form-control-solid">
                                </div> --}}
                                <div class="mb-4">
                                    <label class="form-label">Title</label>
                                    <input type="text" value="{{ $journal->title }}"  name="title" required
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Author</label>
                                    <input type="text" value="{{ $journal->author }}"  name="author" required
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Published On</label>
                                    <input type="date" value="{{ $journal->published_on }}"  name="published_on" required
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="description" class="form-control form-control-lg form-control-solid editor" rows="12"
                                        placeholder="Textarea" rows="1">{{ $journal->description }}</textarea>
                                </div>


                                <div class="mb-4">
                                    <div class="mb-4 dnone @if( $journal->document) d-none @endif" id="file-input-wrapper">
                                    ...
                                    <div class="file-preview-thumbnails @if(!$journal->document) d-none @endif" id="file-preview">
                                        <div class="file-preview-frame file-sortable  kv-preview-thumb"
                                            ...
                                            <div class="file-thumbnail-footer">
                                                <div class="file-detail">
                                                    <div class="file-caption-name" id="fileName">{{ $journal->slug }}_cv.pdf</div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number" value="{{ $journal->sort_order }}" required name="sort_order"
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="avatar-upload">
                                ...
                                <div class="avatar-preview">
                                    <div id="imagePreview"
                                        style="background-image: url({{ $journal->image }});">
                                    </div>
                                </div>
                            </div>
