        ...
        <div class="container-fluid p-0">
            ...
            <div class="row mb-2 mb-xl-3">
                ...
                <div class="col-auto ms-auto text-end mt-n1">
                    <a href="{{ route('get.dashboard.newNews') }}" class="btn btn-primary">Add New</a>
                </div>
                @endif
            </div>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ route('get.dashboard.viewNews', $item->id ) }}">View</a>
                                                @if($isWritePermission)
                                                <a class="dropdown-item" href="{{ route('get.dashboard.viewNews', ['id' => $item->id, 'isEdit' => 'true']) }}">Edit</a>
