...
@section('content')
        ...
        <div class="container-fluid p-0">
            ...
            <div class="row mb-2 mb-xl-3">
                ...
                <div class="col-auto ms-auto text-end mt-n1">
                    <a href="{{ route('get.dashboard.newJournal') }}" class="btn btn-primary">Add New</a>
                </div>
                @endif
            </div>
                        ...
                        <tbody>
                            @foreach ($journals as $item)
                                <tr>
                                    ...
                                    <td><a href="{{ $item->document }}" download class="btn btn-sm btn-secondary">Download</a></td>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ route('get.dashboard.viewJournal', $item->id ) }}">View</a>
                                                @if($isWritePermission)
                                                <a class="dropdown-item" href="{{ route('get.dashboard.viewJournal', ['id' => $item->id, 'isEdit' => 'true']) }}">Edit</a>
    ...
    <form data-action="{{ route('post.dashboard.publishPost') }}" id="publish-post-form" data-ajaxify="true"
        ...
        <input type="hidden" name="redirect" value="{{ route('get.dashboard.journals') }}" />
    </form>
