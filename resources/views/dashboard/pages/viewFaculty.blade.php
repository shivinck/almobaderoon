...
@section('content')
        ...
        <div class="container-fluid p-0">
            ...
            <div class="row mb-2 mb-xl-3">
                <div class="col-auto d-none d-sm-block">
                    <h3><strong>Vew Faculty</strong></h3>
                </div>

                <div class="col-auto ms-auto text-end mt-n1">
                    @if(!$isEdit)
                    <a href="{{ route('get.dashboard.viewFaculty', ['id' => $faculty->id, 'isEdit' => 'true']) }}" class="btn btn-primary">Edit Details</a>
                    @endif
                </div>
            </div>
                ...
                <div class="col-xl-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form data-action="{{ route('update.dashboard.faculty') }}" id="faculty-form" data-ajaxify="true"
                                data-method="POST" class="js-validation" novalidate>
                                <input type="hidden" value="{{ $faculty->id }}" name="id" id="id" />
                                <input type="hidden" value="{{ $faculty->image }}" name="image" id="image" />
                                <input type="hidden" value="{{ $faculty->cv }}" name="cv" id="document" />
                                <div class="mb-4">
                                    <label class="form-label">Faculty Name</label>
                                    <input type="text" value="{{ $faculty->name }}" name="name" required
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Designation</label>
                                    <input type="text" value="{{ $faculty->designation }}"  name="designation"
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Location</label>
                                    <input type="text" value="{{ $faculty->location }}" name="location"
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Phone</label>
                                    <input type="text" value="{{ $faculty->phone }}"  name="phone"
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Email</label>
                                    <input type="email" value="{{ $faculty->email }}" name="email"
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Description</label>
                                    <textarea name="description" class="form-control form-control-lg form-control-solid editor" rows="12"
                                        placeholder="Textarea" rows="1">{{ old('content', $faculty->description) }}</textarea>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Biography</label>
                                    <textarea name="biography" class="form-control form-control-lg form-control-solid editor" rows="12"
                                        placeholder="Textarea" rows="1">{!! $faculty->biography !!}</textarea>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Experience</label>
                                    <textarea name="experience" class="form-control form-control-lg form-control-solid editor" rows="12"
                                        placeholder="Textarea" rows="1">{{ $faculty->experience }}</textarea>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Education</label>
                                    <textarea name="education" class="form-control form-control-lg form-control-solid editor" rows="12"
                                        placeholder="Textarea" rows="1">{{ $faculty->education }}</textarea>
                                </div>

                                <div class="mb-4">
                                    <div class="mb-4 dnone @if( $faculty->cv) d-none @endif" id="file-input-wrapper">
                                        <label class="form-label">CV File</label>
                                        <input type="file" name="cvfile" accept="application/pdf"
                                            class="form-control form-control-lg form-control-solid" id="fileInput"
                                            accept="pdf" />
                                    </div>

                                    <div class="file-preview-thumbnails @if(!$faculty->cv) d-none @endif" id="file-preview">
                                        <div class="file-preview-frame file-sortable  kv-preview-thumb"
                                            data-template="image" data-zoom="">
                                            <div class="kv-file-content">
                                                <img src="https://cdn-icons-png.flaticon.com/128/337/337946.png"
                                                    class="file-preview-image kv-preview-data" title=""
                                                    alt=""
                                                    style="width: auto; height: auto; max-width: 100%; max-height: 100%; image-orientation: from-image;">
                                            </div>
                                            <div class="file-thumbnail-footer">
                                                <div class="file-detail">
                                                    <div class="file-caption-name" id="fileName">{{ $faculty->slug }}_cv.pdf</div>
                                                    <div class="file-size" id="fileSize"> <samp>(354.26 KB)</samp></div>
                                                </div>
                                                <div class="file-actions dnone">
                                                    <div class="file-footer-buttons">
                                                        <button type="button" id="remove-file"
                                                            class="kv-file-remove file-remove" title="Remove file"><i
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{ $faculty->facebook }}" name="facebook"
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">LinkedIn Profile</label>
                                    <input type="text" value="{{ $faculty->linkedin }}" name="linkedin"
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Twitter Profile</label>
                                    <input type="text" value="{{ $faculty->linkedin }}" name="twitter"
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Skype Profile</label>
                                    <input type="text" value="{{ $faculty->skype }}" name="skype"
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Youtube Profile</label>
                                    <input type="text" value="{{ $faculty->youtube }}" name="youtube"
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Sort Order</label>
                                    <input type="number" value="{{ $faculty->sort_order }}" name="sort_order"
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="avatar-upload">
                                ...
                                <div class="avatar-preview">
                                    <div id="imagePreview"
                                        style="background-image: url({{ $faculty->image }});">
                                    </div>
                                </div>
                            </div>
    ...
    <form data-action="{{ route('post.dashboard.uploadDocument') }}" id="document-upload-form" data-ajaxify="true"
        ...
        <input type="hidden" name="name" id="fileDataInputName" />
    </form>
    @push('scripts')
        <script>
            $(function() {
            ...
            function inPageMethod(response) {
                if (!response.message.endsWith('.pdf')) {
                    ...
                    document.getElementById('document').value = response.message;
                }
            ...
            document.getElementById('fileInput').addEventListener('change', function(event) {
                ...
                if (file) {
                    ...
                    document.getElementById('file-input-wrapper').classList.add('d-none');
                    event.target.value = null;

                    document.getElementById('fileName').innerHTML = file.name;
                    document.getElementById('fileSize').innerHTML = `(${fileSizeInMB})`;

                    const reader = new FileReader();
                    reader.onloadend = function() {
                        const base64String = reader.result.split(',')[1];
                        document.getElementById('fileDataInput').value = base64String;
                        document.getElementById('fileDataInputName').value = file.name;
                        document.getElementById('save-btn').disabled = true;
            ...
            document.getElementById('remove-file').addEventListener('click', function(event) {
                document.getElementById('file-preview').classList.add('d-none');
                document.getElementById('file-input-wrapper').classList.remove('d-none');
                document.getElementById('fileDataInput').value = null;
