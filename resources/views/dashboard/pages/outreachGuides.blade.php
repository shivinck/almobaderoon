...
@section('content')
        ...
        <div class="container-fluid p-0">
            ...
            <div class="row mb-2 mb-xl-3">
                <div class="col-auto d-none d-sm-block">
                    <h3><strong>Outreach Faculty</strong></h3>
                </div>
                @if($isWritePermission)
                <div class="col-auto ms-auto text-end mt-n1">
                    <a href="{{ route('get.dashboard.newFacultyOutreach') }}" class="btn btn-primary">Add New</a>
                </div>
                @endif
            </div>
                        ...
                        <tbody>
                            @foreach ($faculties as $item)
                                <tr>
                                    ...
                                    <td><img src="{{ $item->faculty->image }}" width="32" height="32" class="rounded-circle my-n1" alt="Avatar"></td>
                                    <td><strong>{{ $item->faculty->name }}</strong></td>
                                    <td>{{ $item->faculty->designation }}</td>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ route('get.dashboard.viewFaculty', $item->faculty->id ) }}">View</a>
    ...
    <form data-action="{{ route('post.dashboard.publishPost') }}" id="publish-post-form" data-ajaxify="true"
        ...
        <input type="hidden" name="type" value="outreachGuide" />
        <input type="hidden" name="redirect" value="{{ route('get.dashboard.facultyOutreach') }}" />
    </form>
