...
@section('content')
    ...
    <main class="content">
        <div class="container-fluid p-0">
            ...
            <div class="mb-3">
                <h1 class="h3 d-inline align-middle">View Announcement</h1>
            </div>
                ...
                <div class="col-xl-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form data-action="{{ route('update.dashboard.announcement') }}" id="event-form"
                                data-ajaxify="true" data-method="POST" class="js-validation" novalidate>
                                <input type="hidden" name="image" value="{{ $announcement->image }}" id="image" />
                                <input type="hidden" name="id" value="{{ $announcement->id }}" id="id" />
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="short_description" class="form-control form-control-lg form-control-solid " rows="6"
                                        placeholder="Textarea">{{ $announcement->short_description }}</textarea>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Content</label>
                                    <textarea name="content" class="form-control form-control-lg form-control-solid editor" rows="18"
                                        placeholder="Textarea">{{ $announcement->content }}</textarea>
                                </div>

                                <div class="mb-4">
                                    <label class="form-label">Tags</label>
                                    <input type="text" name="tags" value="{{ join(',', $announcement->tags) }}"
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="seo_tags" class="form-control form-control-lg form-control-solid " rows="12"
                                        placeholder="Textarea" rows="8">{{ $announcement->seo_tags }}</textarea>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Sort Order</label>
                                    <input type="number" value="{{ $announcement->sort_order }}" required name="sort_order"
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="avatar-upload">
                                ...
                                <div class="avatar-preview">
                                    <div id="imagePreview" style="background-image: url({{ $announcement->image }});">
                                    </div>
                                </div>
                            </div>
