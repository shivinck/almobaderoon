...
@section('content')
    ...
    <main class="content">
        <div class="container-fluid p-0">
            ...
            <div class="mb-3">
                <h1 class="h3 d-inline align-middle">View News</h1>
            </div>
                ...
                <div class="col-xl-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form data-action="{{ route('update.dashboard.news') }}" id="news-form" data-ajaxify="true"
                                data-method="POST" class="js-validation" novalidate>
                                <input type="hidden" value="{{ $news->id }}" name="id" id="id" />
                                <input type="hidden" value="{{ $news->image }}" name="image" id="image" />
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="short_description" class="form-control form-control-lg form-control-solid " rows="6"
                                        placeholder="Textarea">{{ $news->short_description }}</textarea>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Content</label>
                                    <textarea name="content" class="form-control form-control-lg form-control-solid editor" rows="18"
                                        placeholder="Textarea">{{ $news->content }}</textarea>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Tags <small>Coma Separated.</small></label>
                                    <input type="text" value="{{ join(',', $news->tags) }}" name="tags" required
                                        class="form-control form-control-lg form-control-solid">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Meta tags</label>
                                    <textarea name="seo_tags" class="form-control form-control-lg form-control-solid " rows="12"
                                        placeholder="Textarea" rows="8">{{ $news->seo_tags }}</textarea>
                                </div>
