  ...
  <head>
	...
	>
        <div style="display: none;">
            <p>
            Thanks for registering for an account on FitoutConnect! Before we get started, we just need to confirm that this is you. Click below to verify your email address:
            </p>
        </div>
		<!--
			| email container
							...
							<td>
								<p
									style="text-align: center;
										...
										padding: 0 20px;"
								>
									To ensure delivery, add <a href="mailto:no-reply@fitoutconnnect.com" style="color: #0069FF">no-reply@fitoutconnnect.com</a> to your address book
								</p>
							</td>
						</tr>
					</table>
								...
								>
									<tr>
										<td align="center">
											...
											-->
											<img
												src="https://nyc1-01.fitoutconnect.com/webstatic/sites/zweb/images/branding/logos/logo-092023.png"
										...
										<td>
											<p
												style="font-family: Arial, Helvetica, sans-serif;
													...
													text-align: left;"
											>
												https://fitoutconnect.com/password-reset/AbCDeFGhIJKLm
											</p>
										</td>
									</tr>
								</table>
										...
										<td>
											<p
												style="font-family: Arial, Helvetica, sans-serif;
													...
													text-align: center"
											>
												Fermentum varius, <a href="mailto:yennifer@mail.com" style="color: #0069FF">support@fitoutconnnect.com</a>
												<br />
